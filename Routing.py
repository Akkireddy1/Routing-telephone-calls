"""
To store the data i have used dictionary & to find method of the string class to implement the character matching
at the beginning of the string..
"""

# Telephone operators have given their price lists including price per minute for different phone number prefixes
...
if __name__ == '__main__':
    while True:
        telephone_number = input(u'Please input your telephone number: ')
        # number filter
        telephone_number = telephone_number.replace('+', '')
        telephone_number = telephone_number.replace('-', '')
        telephone_number = telephone_number.replace(' ', '')
        # print 'telephone_number = %s' % telephone_number
        # enter the phone number to get Cheapest price
